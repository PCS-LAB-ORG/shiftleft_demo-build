...
resource "aws_security_group" "k8s-security-group" {
  ...
  tags = {
    yor_trace = "76b63b30-d614-4015-9b30-f36779982e32"
  }
}
...
resource "aws_instance" "ci-sockshop-k8s-master" {
  ...
  tags = {
    yor_trace = "e75f6392-350f-43a5-adec-ff7814e8851a"
  }
}
...
resource "aws_instance" "ci-sockshop-k8s-node" {
  ...
  tags = {
    yor_trace = "05e7f481-08c7-4898-ae08-88387f661754"
  }
}
...
resource "aws_elb" "ci-sockshop-k8s-elb" {
  ...
  tags = {
    yor_trace = "4a27e33a-2efe-48dd-bb90-86f4222220c1"
  }
}
