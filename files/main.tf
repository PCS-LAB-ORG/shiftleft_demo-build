...
resource "aws_security_group" "k8s-security-group" {
  ...
  tags = {
    yor_trace = "4368b912-c5f2-4e93-ad04-ac03910a1ffd"
  }
}
...
resource "aws_instance" "ci-sockshop-k8s-master" {
  ...
  tags = {
    yor_trace = "d63579fe-a70a-4cae-9a2c-74bab491c6d6"
  }
}
...
resource "aws_instance" "ci-sockshop-k8s-node" {
  ...
  tags = {
    yor_trace = "72ccd8c9-4abf-469c-aa20-3cdaad5df86c"
  }
}
...
resource "aws_elb" "ci-sockshop-k8s-elb" {
  ...
  tags = {
    yor_trace = "1a0d0e15-8df6-4513-975a-8aac5dc46926"
  }
}
