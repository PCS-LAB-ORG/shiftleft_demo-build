...
resource "aws_security_group" "k8s-security-group" {
  ...
  tags = {
    yor_trace = "b0a1dbdb-05c7-4b4e-8da4-095e304f2fb4"
  }
}
...
resource "aws_instance" "ci-sockshop-k8s-master" {
  ...
  tags = {
    yor_trace = "c0dcaea6-f127-40f8-a9a8-a9b19344971c"
  }
}
...
resource "aws_instance" "ci-sockshop-k8s-node" {
  ...
  tags = {
    yor_trace = "2e14c376-87f6-4ec5-a56b-24644b7e0a9c"
  }
}
...
resource "aws_elb" "ci-sockshop-k8s-elb" {
  ...
  tags = {
    yor_trace = "76b1f14f-a271-4e1a-b0bc-50ab87ed421f"
  }
}
