...
resource "aws_security_group" "k8s-security-group" {
  ...
  tags = {
    yor_trace = "9a4957b5-d215-4a0a-99fd-81d1350d5ae6"
  }
}
...
resource "aws_instance" "ci-sockshop-k8s-master" {
  ...
  tags = {
    yor_trace = "04c4dd3f-6aac-47fb-ba36-53e6f2bdd1fc"
  }
}
...
resource "aws_instance" "ci-sockshop-k8s-node" {
  ...
  tags = {
    yor_trace = "d044cd78-f88e-4678-ba54-b169eb311b88"
  }
}
...
resource "aws_elb" "ci-sockshop-k8s-elb" {
  ...
  tags = {
    yor_trace = "9ff64312-c02b-4341-a979-90db6d2e8e66"
  }
}
